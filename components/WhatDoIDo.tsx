...
export default function WhatDoIDo() {
    ...
    return (
        <div className="about-text" id="whatdoido">
            <h3 className="green">What Do I Do</h3>
            <h1 className="white">Web Systems and Mobile Apps</h1>
            <h3 className="white">Android and iOS Apps and Javascript or PHP based Web systems</h3>
            <p className="gray">Development of mobile Apps using Flutter and React Native, which means Android and iOS Smartphones and Tablets. Complete Web systems, being able to use a wide variety of technologies, including your legacy system. </p>
