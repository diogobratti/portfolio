...
export default function Portfolio() {
    ...
    return (
        <section id="portfolio" className="flex-column">
            <div className="about-text">
                <h3 className="text-green-400">Portfolio</h3>
            </div>
...
function PortfolioCard({ title, icon, description, technology, website, github, playstore, docAndCodeCanBeShown }: Props) {
    return (
        <div className="portfolio-card flex-column justify-center align-center">
        <div className="bg-zinc-800 portfolio-card flex-column justify-center align-center">
            ...
            <p className="text-neutral-500">Technologies used: {technology}</p>
